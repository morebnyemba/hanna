        ...
        },
        {
            ...
            "config": {
                "actions_to_run": [{
                    ...
                    "model_name": "Order",
                    "fields_template": {
                        "customer_id": "{{ target_customer_profile.0.contact_id if target_customer_profile else created_profile_instance.contact_id }}",
