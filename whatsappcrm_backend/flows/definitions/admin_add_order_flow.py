        ...
        },
        {
            ...
            "config": {
                "actions_to_run": [{
                    ...
                    "model_name": "Order",
                    "fields_template": {
                        "customer_id": "{{ target_customer_profile.0.contact_id if target_customer_profile else created_profile_instance.contact }}",
        ...
        },
        {
            ...
            "config": {
                "actions_to_run": [
                    ...
                    {"action_type": "send_group_notification", "params_template": {"group_names": ["Pfungwa Staff", "System Admins"], "template_name": "pfungwa_admin_order_and_install_created"}}
                ]
            },
