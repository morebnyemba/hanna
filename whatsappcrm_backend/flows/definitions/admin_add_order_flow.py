        ...
        },
        {
            ...
            "config": {
                "actions_to_run": [{
                    ...
                    "model_name": "Order",
                    "fields_template": {
                        "customer_id": "{{ target_contact.0.id if target_contact else created_contact_instance.contact_id }}",
