    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier_sku', models.CharField(blank=True, help_text='Original supplier or partner provided product code.', max_length=120, null=True, verbose_name='Supplier SKU')),
                ('provisional', models.BooleanField(default=False, help_text='Marks products auto-created from imports pending review.', verbose_name='Provisional')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('in_stock', 'In Stock'), ('reserved', 'Reserved'), ('sold', 'Sold'), ('awaiting_delivery', 'Awaiting Delivery'), ('delivered', 'Delivered'), ('awaiting_collection', 'Awaiting Collection'), ('in_transit', 'In Transit'), ('in_repair', 'In Repair'), ('awaiting_parts', 'Awaiting Parts'), ('outsourced', 'Outsourced to Third Party'), ('repair_completed', 'Repair Completed'), ('returned', 'Returned'), ('warranty_claim', 'Warranty Claim Processing'), ('replacement_pending', 'Replacement Pending'), ('decommissioned', 'Decommissioned'), ('disposed', 'Disposed')], db_index=True, default='in_stock', help_text='The current status of this individual item.', max_length=30, verbose_name='Status')),
                ('current_location', models.CharField(choices=[('warehouse', 'Warehouse'), ('customer', 'With Customer'), ('manufacturer', 'At Manufacturer'), ('technician', 'With Technician'), ('in_transit', 'In Transit'), ('outsourced', 'Outsourced Service'), ('retail', 'Retail Store'), ('disposed', 'Disposed/Scrapped')], db_index=True, default='warehouse', help_text='The current physical location of this item.', max_length=20, verbose_name='Current Location')),
                ('location_notes', models.TextField(blank=True, help_text='Additional location details or address information', verbose_name='Location Notes')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('current_holder', models.ForeignKey(blank=True, help_text='Current person/entity holding the item (technician, customer, etc.)', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='held_items', to=settings.AUTH_USER_MODEL)),
