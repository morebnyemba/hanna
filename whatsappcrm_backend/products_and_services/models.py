...
class Product(models.Model):
    ...
    barcode = models.CharField(_("Barcode"), max_length=255, unique=True, blank=True, null=True, db_index=True, help_text=_("Barcode value for product identification"))
    description = models.TextField(_("Description"), blank=True, null=True)
...
class SerializedItem(models.Model):
    ...
    barcode = models.CharField(_("Barcode"), max_length=255, unique=True, blank=True, null=True, db_index=True, help_text=_("Barcode value for item identification"))
