  ...
  return (
    <>
      <div className="mb-6 flex justify-between items-center">
        ...
        <Link href="/admin/flows" className="flex items-center justify-center px-4 py-2 bg-gray-200 text-gray-800 rounded-md hover:bg-gray-300 transition">
        ...
        <form onSubmit={handleSubmit}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
                <InputField id="name" label="Flow Name" value={formData.name} onChange={handleChange} placeholder="e.g., New Order Flow" required />
            </div>
            <div className="md:col-span-2">
                <TextAreaField id="description" label="Description" value={formData.description} onChange={handleChange} placeholder="A short description of what this flow does." />
            </div>
            <div className="md:col-span-2">
                <InputField id="trigger_keywords" label="Trigger Keywords (comma-separated)" value={formData.trigger_keywords} onChange={handleChange} placeholder="e.g., order, buy, purchase" required />
            </div>
          </div>
