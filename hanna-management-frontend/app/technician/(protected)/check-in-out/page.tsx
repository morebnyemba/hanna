...
export default function TechnicianCheckInOutPage() {
  ...
  const [destination, setDestination] = useState('technician');
  const [arrivalLocation, setArrivalLocation] = useState('technician');
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold flex items-center gap-2"><Truck className="w-6 h-6" /> Technician Check-In / Check-Out</h1>
